"""
Module Implementing the Symbolic Decoder.

A transformer-based decoder where the 'input' is an input-independent learned sequence of vectors (thought of as symbols),
and symbol-encoder cross-attention uses the scheme Q=D, K=E, V=D
"""
...
class SymbolicDecoder(tf.keras.layers.Layer):
    """
    A transformer-based 'Symbolic' Decoder.

    The 'input' at the decoder is a sequence of input-independent learnable symbolic vectors.
    Implements cross-attention between these symbols and the entities at the encoder.
    Uses the scheme Q=D, K=E, V=D.
    """
