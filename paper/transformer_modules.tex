...
states to influence the learning and transformation of abstract states. The Abstractor framework enables domain-specific relations to be modeled in the Encoder, as done by standard transformers, giving the framework more 
flexitility relative to ESBN.
