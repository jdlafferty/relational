...
\begin{frontmatter}
{\bf\Large Abstractors and relational cross-attention: An inductive bias for explicit relational reasoning in Transformers}
...
Code, experimental logs, and instructions for reproducing our results are available at: \url{https://github.com/jdlafferty/relational}
