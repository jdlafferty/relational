...
One recent work on relational machine learning is~\cite{kerg2022neural} where, based on prior work of \cite{esbn}, the
...
\begin{figure*}
    ...
    \caption{Experiments. Shaded regions indicate twice the standard error of the mean.}\label{fig:experiments}
    \vskip-.10in
\end{figure*}
