...
\subsubsection{SET: The versatility of multi-dimensional relations}

The $\prec$ relation is a one-dimensional relation. Similarly, the relation in the experiments considered in~\citep{kerg2022neural} are also one-dimensional (same/different). In the next experiment, we explore a discriminative relational tasks which relies on a multi-dimensional relation. The task we consider is SET. 
