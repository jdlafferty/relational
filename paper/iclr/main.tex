...
% since Transformers can model relations implicitly through self-attention / cross-attention, but this produces entangled representations
% also, should we use the word "reasoning"? or should we focus more on "representation"?
%\title{Abstractors and relational cross-attention: An extension of transformers for \\ explicit relational reasoning}
\title{Abstractors and relational cross-attention: A novel inductive bias for explicit relational reasoning in Transformers}
...
\clearpage
\appendix
\input{appendix/multi_attn_decoder_alg}
\input{appendix/appendix_experimental_details}
\input{appendix/appendix_additional_experiments}
