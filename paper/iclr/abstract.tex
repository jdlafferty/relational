\begin{abstract}
    ...
    We begin our empirical evaluation in a more controlled setting with a set of discriminative and generative relational tasks, where we compare to existing relational architectures and standard Transformers, observing dramatic improvements in sample-efficiency. Following this, we compare the Abstractor to a Transformer on a more realistic set of tasks based solving math problems, and observe a modest but consistent improvement in performance and sample efficiency.
\end{abstract}
