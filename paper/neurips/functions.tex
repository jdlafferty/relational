...
In this section, we analyze the class of functions computable by symbolic message-passing as described in~\Cref{alg:symbolic_mp}. We view this operation as processing relations, mapping a relation tensor to a sequence of objets.
