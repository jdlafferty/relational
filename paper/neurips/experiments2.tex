...
it is only able to model symmetric relations\footnote{This is not fundamental to the CoRelNet model. The authors briefly explore an asymmetric version of CoRelNet but conclude that symmetry is a useful inductive bias for the tasks they consider.}---$A$ is symmetric by definition.
