...
\begin{figure}
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        %\centering
        \hskip-.3in\includegraphics{figures/experiments/pairwise_order_learning_curves.pdf}
        \vskip-5pt
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        %\centering
        \hskip-.3in\includegraphics{figures/experiments/random_object_sorting.pdf}
        \vskip-5pt
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        %\centering
        \hskip-.3in\includegraphics{figures/experiments/random_object_sorting_generalization.pdf}
        \vskip-5pt
        \caption{Learning curves with and without pre-training on a similar sorting task. The Abstractor benifits significantly from pre-training the relation.}\label{fig:exp_object_sorting_generalization}
    \end{subfigure} \hspace{\fill}
    \begin{subfigure}[t]{0.45\textwidth}
        %\centering
        \hskip-.3in\includegraphics{figures/experiments/multiplicative_robustness.pdf}
        \vskip-5pt
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        %\centering
        \vskip10pt
        \hskip-.3in\includegraphics{figures/experiments/set_symbolic_vs_abstractor.pdf}
        \vskip-5pt
        \caption{Comparison of Abstractor trained on images of cards and MLP with relations hand-encoded symbolically as bit vectors.}\label{fig:exp_set}
    \end{subfigure}
