...
% pairwise -- JDC: WOULD DELETE;  THE POINT IS MORE GENERAL, EVEN IF OUR IMPLEMENTATION FOCUSES ON 1ST ORDER RELATIONS
...
This
%In its most basic and simplified form, the
