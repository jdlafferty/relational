...
\begin{figure}
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
		\begin{tabular}{c}
		\includegraphics[width=.6\textwidth]{figures/set/set_example}\\
		\includegraphics[width=.6\textwidth]{figures/set/notset_example}\\[5pt]
		\end{tabular}
        \caption{The top three cards form a SET; the bottom three do not.}
    \end{subfigure} \hspace{\fill}
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
		\includegraphics[width=1\textwidth]{figures/set/set_symbolic_vs_abstractor.pdf}
