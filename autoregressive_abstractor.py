...
# NOTE: old implementation with standard decoder and simply concatenating contexts together.
# The implementation above uses the MultiAttentionDecoder and is more versatile. (e.g., it allows for contexts of different lengths, dimensions, etc)
# temporarily keeping the old implementation here for reference.
